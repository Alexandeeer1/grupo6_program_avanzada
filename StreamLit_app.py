...
columnas=["CODIGO_ENTIDAD",
          ...
          "LONGITUD",
          "FECHA_CORTE"]
Licencia_Institucional=pd.read_excel(r'https://github.com/Alexandeeer1/grupo6_program_avanzada/raw/main/Licenciamiento-Institucional_7.xlsx', names=columnas)
